...
namespace LeboncoinAPI.Migrations
{
    ...
    [Migration("20260325050012_IncidentWorkflowRbac")]
    partial class IncidentWorkflowRbac
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LeboncoinAPI.Models.EntityFramework.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Idpermission = 1,
                            Nompermission = "incident.create"
                        },
                        new
                        {
                            Idpermission = 2,
                            Nompermission = "incident.read.own"
                        },
                        new
                        {
                            Idpermission = 3,
                            Nompermission = "incident.read.property"
                        },
                        new
                        {
                            Idpermission = 4,
                        ...
                        {
                            Idpermission = 8,
                            Nompermission = "incident.submit_owner_explanation"
                        },
                        new
                        {
                            Idpermission = 9,
                        ...
                        {
                            Idpermission = 11,
                            Nompermission = "incident.accept_refusal"
                        },
                        new
                        {
                            Idpermission = 12,
                            Nompermission = "incident.contest_refusal"
                        },
                        new
                        {
                            Idpermission = 13,
