            ...
            <div class="p-6 flex-grow flex flex-col justify-between">
                ...
                <div class="flex items-center justify-between gap-4 mt-6 pt-4 border-t border-gray-50">
                    <div class="flex items-center gap-4">
                        <button @click="goToMessage(res.idannonceNavigation?.idutilisateur)" class="text-xs font-black text-gray-500 hover:text-orange-600 transition-colors uppercase tracking-wider flex items-center gap-1.5">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4 h-4">
