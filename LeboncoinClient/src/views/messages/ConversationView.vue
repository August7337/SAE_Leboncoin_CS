...
<template>
  <div
    class="h-screen bg-white flex flex-col max-w-4xl mx-auto border-x border-gray-100 shadow-2xl"
  >
    <div
      class="p-4 border-b border-gray-100 flex items-center gap-4 bg-white/80 backdrop-blur-md sticky top-0"
    >
      ...
      <div
        class="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center font-bold text-[#ea580c]"
      >
    ...
    <div class="flex-1 overflow-y-auto p-6 space-y-6 bg-[#fcfcfc]">
      <div
        ...
        :key="msg.id"
        :class="
          msg.expediteurId === authState.user.idutilisateur
            ? 'flex justify-end'
            : 'flex justify-start'
        "
      >
    ...
    <div class="p-6 border-t border-gray-100 bg-white">
      <form @submit.prevent="sendMessage" class="flex gap-3">
        ...
        <button
          type="submit"
          class="bg-[#ea580c] text-white p-4 rounded-2xl hover:bg-[#c2410c] transition-all shadow-lg shadow-orange-200"
        >
