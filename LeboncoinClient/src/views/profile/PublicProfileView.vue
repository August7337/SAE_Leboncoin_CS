...
<template>
  <div class="min-h-screen bg-white">
    ...
    <div class="h-32 bg-gradient-to-r from-slate-50 to-slate-100 border-b border-slate-200"></div>
    ...
    <div class="max-w-5xl mx-auto px-4 -mt-16 pb-20">
      ...
      <div v-else-if="seller">
        <!-- Seller Card (Same as Detail Page) -->
          ...
          <div class="flex flex-col md:flex-row gap-8 items-start md:items-center">
            <div class="relative flex-shrink-0">
              <img
                ...
                class="w-32 h-32 rounded-full object-cover border-4 border-white shadow-md shadow-slate-200"
              />
              <div 
                v-if="seller.identityVerified"
                class="absolute bottom-0 right-0 bg-blue-500 text-white p-2 rounded-full border-4 border-white shadow-sm"
            ...
            <div class="flex-1 space-y-4 w-full">
              <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="flex gap-2">
                  <span 
                    ...
                    class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-bold bg-green-50 text-green-700 border border-green-100"
                  >
              ...
              <div class="flex flex-wrap gap-8 pt-6 border-t border-slate-100">
                <div class="flex items-center gap-4">
                  <div class="p-3 bg-orange-50 rounded-2xl border border-orange-100">
                    <svg class="w-6 h-6 text-orange-500 fill-current" viewBox="0 0 24 24">
                  ...
                  <div class="flex flex-col">
                    ...
                    <span class="text-sm font-bold text-slate-500 uppercase tracking-wider">{{ seller.nombreAvis || 0 }} avis</span>
                  </div>
                </div>

                <div class="flex items-center gap-4">
                  <div class="p-3 bg-slate-50 rounded-2xl border border-slate-100 text-slate-700">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                  </div>
                  <div class="flex flex-col">
                    <span class="text-2xl font-black text-slate-900">{{ seller.nombreAnnonces || 0 }}</span>
                    <span class="text-sm font-bold text-slate-500 uppercase tracking-wider">annonces en ligne</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div>
          <h2 class="text-2xl font-black text-slate-900 mb-8 flex items-center gap-3">
            ...
            <span class="text-slate-300 font-medium font-sans">({{ annonces.length }})</span>
          </h2>
          ...
          <div v-else class="bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-12 text-center">
            <p class="text-slate-500 font-medium italic">Ce vendeur n'a aucune annonce en ligne pour le moment.</p>
          </div>
        </div>
      </div>
    </div>
...
<style scoped>
/* Glassmorphism subtle effects can be added here if needed */
</style>
