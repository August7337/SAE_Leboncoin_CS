  ...
  <div class="min-h-screen bg-[#f5f5f5] py-10">
    ...
    <div class="max-w-3xl mx-auto px-4">
      ...
      <form @submit.prevent="publishAnnonce" class="space-y-6">
        <div
          v-if="apiError"
          class="bg-red-50 text-red-600 p-4 rounded-2xl text-sm font-bold text-center border border-red-100"
        >
          {{ apiError }}
        </div>
        ...
        >
          ...
          <div>
            ...
            <input
              v-model="form.nombrepersonnesmax"
              type="number"
              class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#ea580c] outline-none transition-all"
            />
          </div>
        ...
        <button
          ...
          class="w-full bg-[#ea580c] text-white font-black py-5 rounded-2xl shadow-lg shadow-orange-100 hover:bg-[#c2410c] transition-all disabled:opacity-50"
        >
