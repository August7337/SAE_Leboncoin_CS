  ...
  <div class="min-h-screen bg-[#f5f5f5]">
    <div class="max-w-6xl mx-auto px-4 md:px-12 xl:px-6 py-8">
      ...
      <div class="w-full flex justify-center mt-4 mb-10">
        <div class="bg-[#f0f4f7] w-fit mx-auto rounded-[32px] px-10 md:px-16 py-8 text-center shadow-sm">
      ...
      <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 mb-10">
        <div class="flex items-center gap-3 overflow-x-auto hide-scrollbar pb-2">
          ...
          <div class="relative flex-grow min-w-[280px]">
            <div class="flex items-center gap-3 px-5 py-3 bg-white border border-gray-200 rounded-[15px] shadow-sm hover:bg-gray-50 text-sm font-medium transition-colors w-full group focus-within:border-[#ea580c]">
...
const mapAnnonceFromApi = (annonceApi) => {
  return {
    ...
    typehebergement: {
      nomtypehebergement: annonceApi.typeHebergement || annonceApi.idtypehebergementNavigation?.nomtypehebergement || 'Logement',
    },
    adresse: {
      ville: {
        nomville: annonceApi.nomville || annonceApi.idadresseNavigation?.idvilleNavigation?.nomville || null,
        codepostal: annonceApi.codepostal || annonceApi.idadresseNavigation?.idvilleNavigation?.codepostal || null,
      },
