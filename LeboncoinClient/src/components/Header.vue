  ...
  >
    ...
    >
      ...
      <nav class="flex items-center gap-6 text-gray-700 shrink-0">
        ...
        <router-link
          :to="authState.user ? '/profil' : '/login'"
          class="relative flex flex-col items-center gap-1 group"
        >
          <div
            class="h-6 w-6 rounded-full overflow-hidden border border-gray-200 group-hover:border-black transition-colors bg-gray-100 flex items-center justify-center"
          >
            <img
              v-if="authState.user"
              :src="
