  ...
  >
    <div class="mx-auto h-16 flex items-center justify-between gap-4 max-w-6xl px-6 md:px-12 xl:px-6">
      ...
      <nav class="flex items-center gap-6 text-gray-700 shrink-0">
        ...
        <router-link to="/profil" class="relative flex flex-col items-center gap-1 group">
          <div
            class="h-6 w-6 rounded-full overflow-hidden border border-gray-200 group-hover:border-black transition-colors"
          >
            <img
              src="https://augustin-tarit.dev/tim.jpeg"
              alt="Avatar"
