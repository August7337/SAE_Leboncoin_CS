...
// État pour suivre l'index du carrousel pour chaque annonce
...
// Simulation favoris (à lier à ton store plus tard)
      ...
      >
        <div class="relative w-full h-64 md:w-80 md:h-52 flex-shrink-0 group">
          ...
          >
            ...
            <template v-else>
              <div class="min-w-full h-full snap-start bg-gray-200 flex items-center justify-center">
          ...
          <div class="absolute top-2 right-2 z-20">
            ...
            >
              <svg
                ...
                :class="isFavorite(annonce.idannonce) ? 'text-red-500 fill-red-500' : 'text-gray-600'"
              >
