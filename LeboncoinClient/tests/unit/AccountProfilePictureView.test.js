...
import AccountProfilePictureView from '@/views/account/AccountProfilePictureView.vue'
...
function createWrapper() {
  return shallowMount(AccountProfilePictureView, {
    global: {
...
describe('AccountProfilePictureView.vue', () => {
  let wrapper
