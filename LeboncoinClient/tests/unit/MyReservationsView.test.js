...
import MyReservationsView from '@/views/account/MyReservationsView.vue'
  ...
  if (url?.includes('/api/reservations/user/')) {
    return Promise.resolve({
      ...
      json: () => Promise.resolve([
        {
          idreservation: 1,
          iddatefinreservationNavigation: { date1: new Date(Date.now() + 86400000).toISOString() },
          iddatedebutreservationNavigation: { date1: new Date().toISOString() },
          idannonceNavigation: { photos: [], titreannonce: 'Test annonce', prixnuitee: 100 },
          prenomclient: 'John',
          nomclient: 'Doe',
        },
      ]),
...
function createWrapper() {
  return shallowMount(MyReservationsView, {
    global: {
...
describe('MyReservationsView.vue', () => {
  let wrapper
