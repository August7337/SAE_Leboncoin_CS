...
import LocataireDecisionView from '@/views/incidents/LocataireDecisionView.vue'
...
function createWrapper() {
  return shallowMount(LocataireDecisionView, {
    global: {
...
describe('LocataireDecisionView.vue', () => {
  let wrapper
