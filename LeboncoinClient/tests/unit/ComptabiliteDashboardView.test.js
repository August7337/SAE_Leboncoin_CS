...
import ComptabiliteDashboardView from '@/views/services/ComptabiliteDashboardView.vue'
...
function createWrapper() {
  return shallowMount(ComptabiliteDashboardView, {
    global: {
...
describe('ComptabiliteDashboardView.vue', () => {
  let wrapper
