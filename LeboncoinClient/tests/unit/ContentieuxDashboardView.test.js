...
import ContentieuxDashboardView from '@/views/services/ContentieuxDashboardView.vue'
...
function createWrapper() {
  return shallowMount(ContentieuxDashboardView, {
    global: {
...
describe('ContentieuxDashboardView.vue', () => {
  let wrapper
