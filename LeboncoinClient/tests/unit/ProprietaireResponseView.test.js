...
import ProprietaireResponseView from '@/views/services/ProprietaireResponseView.vue'
...
function createWrapper() {
  return shallowMount(ProprietaireResponseView, {
    global: {
...
describe('ProprietaireResponseView.vue', () => {
  let wrapper
